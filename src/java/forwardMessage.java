 ...
 * @author JorDavid
 */
@WebServlet(name = "forwardMessage", urlPatterns = {"/forwardMessage"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                String getId = "SELECT messageId, body FROM message";
                ...
                while(rs.next()){
                    ...
                    messageBody = rs.getString("body");
                }
                response.sendRedirect("newMessageForm.jsp");
            } catch (Exception e) {
