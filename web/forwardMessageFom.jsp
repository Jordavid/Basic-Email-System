...
<html>
    <head>
     ...
     <%
            String messgbody = request.getParameter("messBody");
    ...
    <body>
        <div class="NewMessageForm">
            ...
            <table>
                <tr>
                    <td>To</td>
                    <td><input type="email" name="sendTO" placeholder="abcd@domain"></td>
                </tr>
                <tr>
                    <td>Cc</td>
                ...
                <tr>
                    <td>Title</td>
                    <td><input type="text" name="messTitle" value="<%=frwrd + messTitle%>"></td>
                </tr>
            </table><br>
            <textarea rows="15" cols="62" form="newMessForm" name="messageBody" style="font-size: 17px; font-family: arial;"><%=messgbody%></textarea><br>
