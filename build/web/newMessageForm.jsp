    ...
    <body>
        <div class="NewMessageForm">
            ...
            <table>
                <tr>
                    <td>To</td>
                    <td><input type="email" name="sendTO" placeholder ="abcd@doamin"></td>
                </tr>
                <tr>
                    <td>Cc</td>
                    <td><input type="email" name="carCopy" placeholder="abcd@doamin"></td>
                </tr>
                <tr>
                    <td>Title</td>
                    <td><input type="text" name="messTitle" placeholder="Type the title"></td>
                </tr>
            </table><br>
